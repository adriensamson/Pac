...
use Pac\Model\map\ProductTableMap;
...
abstract class BaseProductPeer
{
    ...
    const OM_CLASS = 'Pac\\Model\\Product';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Pac\\Model\\map\\ProductTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Version', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'version', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID, ProductPeer::NAME, ProductPeer::VERSION, ProductPeer::CREATED_AT, ProductPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'VERSION', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'version', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Version' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'version' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID => 0, ProductPeer::NAME => 1, ProductPeer::VERSION => 2, ProductPeer::CREATED_AT => 3, ProductPeer::UPDATED_AT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'VERSION' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'version' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        // Invalidate objects in PurchasePeer instance pool,
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseProductPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Pac\Model\map\ProductTableMap());
      }
    }
