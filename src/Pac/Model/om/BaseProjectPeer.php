...
use Pac\Model\map\ProjectTableMap;
...
abstract class BaseProjectPeer
{
    ...
    const OM_CLASS = 'Pac\\Model\\Project';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Name', 'Description', 'Url', 'Active', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'name', 'description', 'url', 'active', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::ID, ProjectPeer::USER_ID, ProjectPeer::NAME, ProjectPeer::DESCRIPTION, ProjectPeer::URL, ProjectPeer::ACTIVE, ProjectPeer::CREATED_AT, ProjectPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'NAME', 'DESCRIPTION', 'URL', 'ACTIVE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'name', 'description', 'url', 'active', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Name' => 2, 'Description' => 3, 'Url' => 4, 'Active' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'name' => 2, 'description' => 3, 'url' => 4, 'active' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::ID => 0, ProjectPeer::USER_ID => 1, ProjectPeer::NAME => 2, ProjectPeer::DESCRIPTION => 3, ProjectPeer::URL => 4, ProjectPeer::ACTIVE => 5, ProjectPeer::CREATED_AT => 6, ProjectPeer::UPDATED_AT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'NAME' => 2, 'DESCRIPTION' => 3, 'URL' => 4, 'ACTIVE' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'name' => 2, 'description' => 3, 'url' => 4, 'active' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
