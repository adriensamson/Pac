...
abstract class BasePurchase extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Pac\\Model\\PurchasePeer';
    ...
    /**
     * The value for the paypal_callback field.
     * @var        string
     */
    protected $paypal_callback;
    ...
    /**
     * The value for the total_download_count field.
     * Note: this column has a database default value of: 0
     * @var        int
     */
    protected $total_download_count;
    ...
    public function getState()
    {
        ...
        $valueSet = PurchasePeer::getValueSet(PurchasePeer::STATE);
    ...
    /**
     * Get the [paypal_callback] column value.
     *
     * @return string
     */
    public function getPaypalCallback()
    {

        return $this->paypal_callback;
    }
     ...
     */
    public function getGenerationDate($format = 'Y-m-d H:i:s')
    {
        if ($this->generation_date === null) {
            return null;
        }

        if ($this->generation_date === '0000-00-00 00:00:00') {
    ...
    /**
     * Get the [total_download_count] column value.
     *
     * @return int
     */
    ...
    public function setState($v)
    {
        ...
        if ($this->state !== $v) {
            $this->state = $v;
            $this->modifiedColumns[] = PurchasePeer::STATE;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[] = PurchasePeer::AMOUNT;
        }
    ...
    /**
     * Set the value of [paypal_callback] column.
     *
     * @param  string $v new value
     * @return Purchase The current object (for fluent API support)
     */
    public function setPaypalCallback($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->paypal_callback !== $v) {
            $this->paypal_callback = $v;
            $this->modifiedColumns[] = PurchasePeer::PAYPAL_CALLBACK;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = PurchasePeer::VERSION;
        }
    ...
    public function setGenerationDate($v)
    {
        ...
        if ($this->generation_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PurchasePeer::GENERATION_DATE;
            }
    ...
    /**
     * Set the value of [total_download_count] column.
     *
     * @param  int $v new value
     * @return Purchase The current object (for fluent API support)
     */
    public function setTotalDownloadCount($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->total_download_count !== $v) {
            $this->total_download_count = $v;
            $this->modifiedColumns[] = PurchasePeer::TOTAL_DOWNLOAD_COUNT;
        }
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->total_download_count !== 0) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->paypal_callback = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->version = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->generation_date = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->total_download_count = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PurchasePeer::UPDATED_AT)) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PurchasePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PurchasePeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(PurchasePeer::PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`product_id`';
        }
        if ($this->isColumnModified(PurchasePeer::STATE)) {
            $modifiedColumns[':p' . $index++]  = '`state`';
        }
        if ($this->isColumnModified(PurchasePeer::AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`amount`';
        }
        if ($this->isColumnModified(PurchasePeer::PAYPAL_CALLBACK)) {
            $modifiedColumns[':p' . $index++]  = '`paypal_callback`';
        }
        if ($this->isColumnModified(PurchasePeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`version`';
        }
        if ($this->isColumnModified(PurchasePeer::GENERATION_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`generation_date`';
        }
        if ($this->isColumnModified(PurchasePeer::TOTAL_DOWNLOAD_COUNT)) {
            $modifiedColumns[':p' . $index++]  = '`total_download_count`';
        }
        if ($this->isColumnModified(PurchasePeer::CREATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`paypal_callback`':
                        $stmt->bindValue($identifier, $this->paypal_callback, PDO::PARAM_STR);
                        break;
                    case '`version`':
                    ...
                    case '`total_download_count`':
                        $stmt->bindValue($identifier, $this->total_download_count, PDO::PARAM_INT);
                        break;
                    case '`created_at`':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 7:
                ...
                break;
            case 8:
                return $this->getTotalDownloadCount();
                break;
            case 9:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getPaypalCallback(),
            $keys[6] => $this->getVersion(),
            $keys[7] => $this->getGenerationDate(),
            $keys[8] => $this->getTotalDownloadCount(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 7:
                ...
                break;
            case 8:
                $this->setTotalDownloadCount($value);
                break;
            case 9:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setPaypalCallback($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setVersion($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setGenerationDate($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setTotalDownloadCount($arr[$keys[8]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PurchasePeer::STATE)) $criteria->add(PurchasePeer::STATE, $this->state);
        if ($this->isColumnModified(PurchasePeer::AMOUNT)) $criteria->add(PurchasePeer::AMOUNT, $this->amount);
        if ($this->isColumnModified(PurchasePeer::PAYPAL_CALLBACK)) $criteria->add(PurchasePeer::PAYPAL_CALLBACK, $this->paypal_callback);
        if ($this->isColumnModified(PurchasePeer::VERSION)) $criteria->add(PurchasePeer::VERSION, $this->version);
        if ($this->isColumnModified(PurchasePeer::GENERATION_DATE)) $criteria->add(PurchasePeer::GENERATION_DATE, $this->generation_date);
        if ($this->isColumnModified(PurchasePeer::TOTAL_DOWNLOAD_COUNT)) $criteria->add(PurchasePeer::TOTAL_DOWNLOAD_COUNT, $this->total_download_count);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPaypalCallback($this->getPaypalCallback());
        $copyObj->setVersion($this->getVersion());
        $copyObj->setGenerationDate($this->getGenerationDate());
        $copyObj->setTotalDownloadCount($this->getTotalDownloadCount());
    ...
    public function getProduct(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduct === null && ($this->product_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduct->addPurchases($this);
             */
        }
    ...
    public function clear()
    {
        ...
        $this->state = null;
        $this->amount = null;
        $this->paypal_callback = null;
        $this->version = null;
        $this->generation_date = null;
        $this->total_download_count = null;
