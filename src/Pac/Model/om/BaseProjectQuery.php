...
abstract class BaseProjectQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'pac', $modelName = 'Pac\\Model\\Project', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `user_id`, `name`, `description`, `url`, `active`, `created_at`, `updated_at` FROM `project` WHERE `id` = :p0';
        try {
