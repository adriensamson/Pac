...
class ProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Pac.Model.map.ProductTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Pac\\Model\\Product');
    ...
    {
        $this->addRelation('Purchase', 'Pac\\Model\\Purchase', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), 'CASCADE', null, 'Purchases');
    } // buildRelations()
